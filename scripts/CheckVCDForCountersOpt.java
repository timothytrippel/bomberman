...
public class CheckVCDForCountersOpt
{
    static VCD vcd;
    static long maxTime;
    ...
    public static void main(String args[])throws IOException
    {
        ...
        vcd.readValuesFromVCDSuspectsOnly();
        System.out.println("Suspect Signals: " + vcd.signals.size());
	...
	suspects = new ArrayList<SignalHistory>(vcd.signals.size());
